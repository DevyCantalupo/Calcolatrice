...
public class calcolatrice {
    ...
    public static void operator(char operator){
        ...
        scanner.close();
        switch(operator){
            case '+': System.out.println("il risultato è : " + addition(firstNumber,secondNumber));
                break;
            case '-': System.out.println("il risultato è : " + subtraction(firstNumber,secondNumber));
                break;
            case '*': System.out.println("il risultato è : " + multiplication(firstNumber,secondNumber));
                break;
            case '/': System.out.println("il risultato è : " + division(firstNumber,secondNumber));
                break;
            case '^': System.out.println("il risultato è : " + power(firstNumber,secondNumber));
                break;
   ...
   public static void prova2(){
    ...
    public static void operator2(char operator, int[] lista){
        switch(operator){
            case '+': System.out.println("il risultato è : " + addition2(lista));
                break;
            case '-': System.out.println("il risultato è : " + subtraction2(lista));
                break;
            case '*': System.out.println("il risultato è : " + multiplication2(lista));
                break;
            case '/': System.out.println("il risultato è : " + division2(lista));
                break;
            default: System.out.println("input non valido");
        }
    }
